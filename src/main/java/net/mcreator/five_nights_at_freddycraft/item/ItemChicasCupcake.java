...
public class ItemChicasCupcake extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    @GameRegistry.ObjectHolder("five_nights_at_freddycraft:chicascupcake")
    public static final Item block;
    
    public ItemChicasCupcake(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 7);
    }
    
    @Override
    public void initElements() {
        this.elements.items.add(() -> ((Item)new ItemSword(EnumHelper.addToolMaterial("CHICASCUPCAKE", 1, 100000, 4.0f, -2.0f, 2)) {
        ...
        }.setUnlocalizedName("chicascupcake").setRegistryName("chicascupcake")).setCreativeTab(CreativeTabs.COMBAT));
    }
    
    @SideOnly(Side.CLIENT)
    @Override
    public void registerModels(final ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(ItemChicasCupcake.block, 0, new ModelResourceLocation("five_nights_at_freddycraft:chicascupcake", "inventory"));
    }
