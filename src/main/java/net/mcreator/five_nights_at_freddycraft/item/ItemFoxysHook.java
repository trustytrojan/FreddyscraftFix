...
public class ItemFoxysHook extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    @GameRegistry.ObjectHolder("five_nights_at_freddycraft:foxyshook")
    public static final Item block;
    
    public ItemFoxysHook(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 10);
    }
    
    @Override
    public void initElements() {
        this.elements.items.add(() -> ((Item)new ItemSword(EnumHelper.addToolMaterial("FOXYSHOOK", 1, 100000, 4.0f, -1.0f, 2)) {
        ...
        }.setUnlocalizedName("foxyshook").setRegistryName("foxyshook")).setCreativeTab(CreativeTabs.COMBAT));
    }
    
    @SideOnly(Side.CLIENT)
    @Override
    public void registerModels(final ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(ItemFoxysHook.block, 0, new ModelResourceLocation("five_nights_at_freddycraft:foxyshook", "inventory"));
    }
