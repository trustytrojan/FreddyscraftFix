...
public class ItemBonniesGuitar extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    @GameRegistry.ObjectHolder("five_nights_at_freddycraft:bonniesguitar")
    public static final Item block;
    
    public ItemBonniesGuitar(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 4);
    }
    
    @Override
    public void initElements() {
        this.elements.items.add(() -> ((Item)new ItemSword(EnumHelper.addToolMaterial("BONNIESGUITAR", 1, 100000, 4.0f, -2.0f, 2)) {
        ...
        }.setUnlocalizedName("bonniesguitar").setRegistryName("bonniesguitar")).setCreativeTab(CreativeTabs.COMBAT));
    }
    
    @SideOnly(Side.CLIENT)
    @Override
    public void registerModels(final ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(ItemBonniesGuitar.block, 0, new ModelResourceLocation("five_nights_at_freddycraft:bonniesguitar", "inventory"));
    }
