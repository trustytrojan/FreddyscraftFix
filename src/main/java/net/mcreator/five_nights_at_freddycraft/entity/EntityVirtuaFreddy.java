...
public class EntityVirtuaFreddy extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 99;
    public static final int ENTITYID_RANGED = 100;
    
    public EntityVirtuaFreddy(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 61);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "virtuafreddy"), 99).name("virtuafreddy").tracker(64, 3, true).egg(-13369549, -16751104).build());
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/virtua_freddy_64_32.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        ...
        protected Item getDropItem() {
            return new ItemStack(Items.DYE, 1, 2).getItem();
        }
