...
public class EntityWitheredGoldenFreddy extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 39;
    public static final int ENTITYID_RANGED = 40;
    
    public EntityWitheredGoldenFreddy(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 29);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "witheredgoldenfreddy"), 39).name("witheredgoldenfreddy").tracker(64, 3, true).egg(-256, -10066432).build());
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        final Biome[] spawnBiomes = this.allbiomes((RegistryNamespaced<ResourceLocation, Biome>)Biome.REGISTRY);
        EntityRegistry.addSpawn(EntityCustom.class, ModConfig.WitheredGoldenFreddy.weight, ModConfig.WitheredGoldenFreddy.minGroupSize, ModConfig.WitheredGoldenFreddy.maxGroupSize, EnumCreatureType.MONSTER, spawnBiomes);
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/withered_golden_freddy.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        ...
        protected Item getDropItem() {
            return new ItemStack(Blocks.GOLD_BLOCK, 1).getItem();
        }
        
        public SoundEvent getAmbientSound() {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("five_nights_at_freddycraft:entity.goldenfreddy.ambient"));
        }
