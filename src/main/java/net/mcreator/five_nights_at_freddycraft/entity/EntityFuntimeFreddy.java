...
public class EntityFuntimeFreddy extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 105;
    public static final int ENTITYID_RANGED = 106;
    
    public EntityFuntimeFreddy(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 71);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "funtimefreddy"), 105).name("funtimefreddy").tracker(64, 3, true).egg(-1, -13057).build());
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        final Biome[] spawnBiomes = this.allbiomes((RegistryNamespaced<ResourceLocation, Biome>)Biome.REGISTRY);
        EntityRegistry.addSpawn(EntityCustom.class, ModConfig.FuntimeFreddy.weight, ModConfig.FuntimeFreddy.minGroupSize, ModConfig.FuntimeFreddy.maxGroupSize, EnumCreatureType.MONSTER, spawnBiomes);
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/funtime_freddy.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        ...
        public SoundEvent getAmbientSound() {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("five_nights_at_freddycraft:entity.funtimefreddy.ambient"));
        }
