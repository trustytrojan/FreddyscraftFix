...
public class EntityBallora extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 103;
    public static final int ENTITYID_RANGED = 104;
    
    public EntityBallora(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 70);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "ballora"), 103).name("ballora").tracker(64, 3, true).egg(-13434676, -1).build());
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        final Biome[] spawnBiomes = this.allbiomes((RegistryNamespaced<ResourceLocation, Biome>)Biome.REGISTRY);
        EntityRegistry.addSpawn(EntityCustom.class, ModConfig.Ballora.weight, ModConfig.Ballora.minGroupSize, ModConfig.Ballora.maxGroupSize, EnumCreatureType.MONSTER, spawnBiomes);
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/ballora.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        ...
        public SoundEvent getAmbientSound() {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("five_nights_at_freddycraft:entity.ballora.ambient"));
        }
