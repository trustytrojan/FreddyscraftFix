...
public class EntityBalloonBoy extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 21;
    public static final int ENTITYID_RANGED = 22;
    
    public EntityBalloonBoy(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 19);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "balloonboy"), 21).name("balloonboy").tracker(64, 3, true).egg(-3407872, -13421569).build());
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        final Biome[] spawnBiomes = this.allbiomes((RegistryNamespaced<ResourceLocation, Biome>)Biome.REGISTRY);
        EntityRegistry.addSpawn(EntityCustom.class, ModConfig.BalloonBoy.weight, ModConfig.BalloonBoy.minGroupSize, ModConfig.BalloonBoy.maxGroupSize, EnumCreatureType.MONSTER, spawnBiomes);
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/bb.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        public EntityCustom(final World world) {
            ...
            this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ItemBalloon.block, 1));
        }
        ...
        protected Item getDropItem() {
            return new ItemStack(Items.REDSTONE, 1).getItem();
        }
        
        public SoundEvent getAmbientSound() {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("five_nights_at_freddycraft:entity.bbjj.laugh"));
        }
