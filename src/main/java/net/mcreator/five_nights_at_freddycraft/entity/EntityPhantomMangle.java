...
public class EntityPhantomMangle extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 55;
    public static final int ENTITYID_RANGED = 56;
    
    public EntityPhantomMangle(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 37);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "phantommangle"), 55).name("phantommangle").tracker(64, 3, true).egg(-256, -13395712).build());
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/phantom_mangle.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        ...
        public SoundEvent getAmbientSound() {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("five_nights_at_freddycraft:entity.phantommangle.ambient"));
        }
