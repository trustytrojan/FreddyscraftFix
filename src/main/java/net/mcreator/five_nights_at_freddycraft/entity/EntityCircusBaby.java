...
public class EntityCircusBaby extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 101;
    public static final int ENTITYID_RANGED = 102;
    
    public EntityCircusBaby(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 69);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "circusbaby"), 101).name("circusbaby").tracker(64, 3, true).egg(-52429, -1).build());
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        final Biome[] spawnBiomes = this.allbiomes((RegistryNamespaced<ResourceLocation, Biome>)Biome.REGISTRY);
        EntityRegistry.addSpawn(EntityCustom.class, ModConfig.CircusBaby.weight, ModConfig.CircusBaby.minGroupSize, ModConfig.CircusBaby.maxGroupSize, EnumCreatureType.MONSTER, spawnBiomes);
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/circus_baby.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        ...
        public SoundEvent getAmbientSound() {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("five_nights_at_freddycraft:entity.baby.ambient"));
        }
