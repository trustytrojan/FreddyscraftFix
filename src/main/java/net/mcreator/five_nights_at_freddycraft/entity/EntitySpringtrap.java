...
public class EntitySpringtrap extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 47;
    public static final int ENTITYID_RANGED = 48;
    
    public EntitySpringtrap(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 33);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "springtrap"), 47).name("springtrap").tracker(64, 3, true).egg(-16751104, -6697984).build());
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        final Biome[] spawnBiomes = this.allbiomes((RegistryNamespaced<ResourceLocation, Biome>)Biome.REGISTRY);
        EntityRegistry.addSpawn(EntityCustom.class, ModConfig.Springtrap.weight, ModConfig.Springtrap.minGroupSize, ModConfig.Springtrap.maxGroupSize, EnumCreatureType.MONSTER, spawnBiomes);
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/springtrap.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        ...
        protected Item getDropItem() {
            return new ItemStack(Items.ROTTEN_FLESH, 1).getItem();
        }
