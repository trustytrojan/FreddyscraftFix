...
public class EntityWitheredFoxy extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 31;
    public static final int ENTITYID_RANGED = 32;
    
    public EntityWitheredFoxy(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 25);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "witheredfoxy"), 31).name("witheredfoxy").tracker(64, 3, true).egg(-65485, -6750208).build());
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/withered_foxy.png");
                }
            };
