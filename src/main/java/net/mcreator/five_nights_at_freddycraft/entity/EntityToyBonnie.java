...
public class EntityToyBonnie extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 15;
    public static final int ENTITYID_RANGED = 16;
    
    public EntityToyBonnie(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 16);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "toybonnie"), 15).name("toybonnie").tracker(64, 3, true).egg(-16776961, -13382401).build());
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        final Biome[] spawnBiomes = this.allbiomes((RegistryNamespaced<ResourceLocation, Biome>)Biome.REGISTRY);
        EntityRegistry.addSpawn(EntityCustom.class, ModConfig.ToyBonnie.weight, ModConfig.ToyBonnie.minGroupSize, ModConfig.ToyBonnie.maxGroupSize, EnumCreatureType.MONSTER, spawnBiomes);
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/toy_bonnie.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        public EntityCustom(final World world) {
            ...
            this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ItemBonniesGuitar.block, 1));
        }
