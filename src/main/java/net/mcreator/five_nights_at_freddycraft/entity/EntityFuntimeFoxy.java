...
public class EntityFuntimeFoxy extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 107;
    public static final int ENTITYID_RANGED = 108;
    
    public EntityFuntimeFoxy(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 72);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "funtimefoxy"), 107).name("funtimefoxy").tracker(64, 3, true).egg(-1, -65281).build());
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        final Biome[] spawnBiomes = this.allbiomes((RegistryNamespaced<ResourceLocation, Biome>)Biome.REGISTRY);
        EntityRegistry.addSpawn(EntityCustom.class, ModConfig.FuntimeFoxy.weight, ModConfig.FuntimeFoxy.minGroupSize, ModConfig.FuntimeFoxy.maxGroupSize, EnumCreatureType.MONSTER, spawnBiomes);
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/funtime_foxy.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        public EntityCustom(final World world) {
            ...
            this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ItemFoxysHook.block, 1));
        }
        ...
        public SoundEvent getAmbientSound() {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("five_nights_at_freddycraft:entity.funtimefoxy.ambient"));
        }
        ...
        public SoundEvent getDeathSound() {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("five_nights_at_freddycraft:entity.fnafsl.death"));
        }
        ...
        protected void applyEntityAttributes() {
            ...
            if (this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH) != null) {
                this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(45.0);
            }
