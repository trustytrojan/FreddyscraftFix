...
import net.mcreator.five_nights_at_freddycraft.item.*;
...
public class EntityFreddyFazbear extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 1;
    public static final int ENTITYID_RANGED = 2;
    
    public EntityFreddyFazbear(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 3);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "freddyfazbear"), 1).name("freddyfazbear").tracker(64, 3, true).egg(-6724096, -10079488).build());
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        final Biome[] spawnBiomes = this.allbiomes((RegistryNamespaced<ResourceLocation, Biome>)Biome.REGISTRY);
        EntityRegistry.addSpawn(EntityCustom.class, ModConfig.FreddyFazbear.weight, ModConfig.FreddyFazbear.minGroupSize, ModConfig.FreddyFazbear.maxGroupSize, EnumCreatureType.MONSTER, spawnBiomes);
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/freddy_better.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        public EntityCustom(final World world) {
            ...
            this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ItemFreddysMicrophone.block, 1));
        }
        
        protected void initEntityAI() {
            super.initEntityAI();
            this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, EntityPlayerMP.class, true, true));
        ...
        protected Item getDropItem() {
            return new ItemStack(Items.BRICK, 1).getItem();
        }
        
        public SoundEvent getAmbientSound() {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("five_nights_at_freddycraft:entity.freddy.ambient"));
        }
        ...
        public SoundEvent getDeathSound() {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("five_nights_at_freddycraft:entity.fnaf1.death"));
        }
