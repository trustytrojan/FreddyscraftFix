...
public class EntityMangle extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 19;
    public static final int ENTITYID_RANGED = 20;
    
    public EntityMangle(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 18);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "mangle"), 19).name("mangle").tracker(64, 3, true).egg(-10066330, -39169).build());
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        final Biome[] spawnBiomes = this.allbiomes((RegistryNamespaced<ResourceLocation, Biome>)Biome.REGISTRY);
        EntityRegistry.addSpawn(EntityCustom.class, ModConfig.Mangle.weight, ModConfig.Mangle.minGroupSize, ModConfig.Mangle.maxGroupSize, EnumCreatureType.MONSTER, spawnBiomes);
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/mangle.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        ...
        protected Item getDropItem() {
            return new ItemStack(Items.DYE, 1, 13).getItem();
        }
        
        public SoundEvent getAmbientSound() {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("five_nights_at_freddycraft:entity.mangle.ambient"));
        }
