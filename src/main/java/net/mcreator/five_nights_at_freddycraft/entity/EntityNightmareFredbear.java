...
public class EntityNightmareFredbear extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 69;
    public static final int ENTITYID_RANGED = 70;
    
    public EntityNightmareFredbear(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 46);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "nightmarefredbear"), 69).name("nightmarefredbear").tracker(64, 3, true).egg(-205, -3368704).build());
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        final Biome[] spawnBiomes = this.allbiomes((RegistryNamespaced<ResourceLocation, Biome>)Biome.REGISTRY);
        EntityRegistry.addSpawn(EntityCustom.class, ModConfig.NightmareFredbear.weight, ModConfig.NightmareFredbear.minGroupSize, ModConfig.NightmareFredbear.maxGroupSize, EnumCreatureType.MONSTER, spawnBiomes);
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/nightmare_fredbear.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        ...
        protected void applyEntityAttributes() {
            ...
            if (this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH) != null) {
                this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(55.0);
            }
