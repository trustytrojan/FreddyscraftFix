...
public class EntityPhantomPuppet extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 59;
    public static final int ENTITYID_RANGED = 60;
    
    public EntityPhantomPuppet(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 39);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "phantompuppet"), 59).name("phantompuppet").tracker(64, 3, true).egg(-16764160, -16777216).build());
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        final Biome[] spawnBiomes = this.allbiomes((RegistryNamespaced<ResourceLocation, Biome>)Biome.REGISTRY);
        EntityRegistry.addSpawn(EntityCustom.class, ModConfig.PhantomPuppet.weight, ModConfig.PhantomPuppet.minGroupSize, ModConfig.PhantomPuppet.maxGroupSize, EnumCreatureType.MONSTER, spawnBiomes);
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/phantom_puppet.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        ...
        public SoundEvent getAmbientSound() {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("five_nights_at_freddycraft:entity.phantompuppet.ambient"));
        }
