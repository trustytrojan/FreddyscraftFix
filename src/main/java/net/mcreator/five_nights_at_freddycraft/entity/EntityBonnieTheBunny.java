...
public class EntityBonnieTheBunny extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    ...
    public EntityBonnieTheBunny(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 6);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "bonniethebunny"), 3).name("bonniethebunny").tracker(64, 3, true).egg(-16777063, -6723841).build());
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/bonnie_better.png");
                }
            };
