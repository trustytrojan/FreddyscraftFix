...
public class EntityAnimdude extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 95;
    public static final int ENTITYID_RANGED = 96;
    
    public EntityAnimdude(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 59);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "animdude"), 95).name("animdude").tracker(64, 3, true).egg(-10027009, -1).build());
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/animdude.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        ...
        protected Item getDropItem() {
            return new ItemStack(Blocks.DIAMOND_BLOCK, 1).getItem();
        }
