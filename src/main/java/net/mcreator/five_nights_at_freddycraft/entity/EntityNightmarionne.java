...
public class EntityNightmarionne extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 81;
    public static final int ENTITYID_RANGED = 82;
    
    public EntityNightmarionne(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 52);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "nightmarionne"), 81).name("nightmarionne").tracker(64, 3, true).egg(-1, -16777216).build());
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        final Biome[] spawnBiomes = this.allbiomes((RegistryNamespaced<ResourceLocation, Biome>)Biome.REGISTRY);
        EntityRegistry.addSpawn(EntityCustom.class, ModConfig.Nightmarionne.weight, ModConfig.Nightmarionne.minGroupSize, ModConfig.Nightmarionne.maxGroupSize, EnumCreatureType.MONSTER, spawnBiomes);
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/nightmarionne.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        ...
        public SoundEvent getDeathSound() {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("five_nights_at_freddycraft:entity.nightmare.death"));
        }
