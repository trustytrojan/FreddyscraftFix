...
public class EntityNightmareFreddy extends ElementsFiveNightsAtFreddycraftMod.ModElement
{
    public static final int ENTITYID = 61;
    public static final int ENTITYID_RANGED = 62;
    
    public EntityNightmareFreddy(final ElementsFiveNightsAtFreddycraftMod instance) {
        super(instance, 42);
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("five_nights_at_freddycraft", "nightmarefreddy"), 61).name("nightmarefreddy").tracker(64, 3, true).egg(-3394816, -10079488).build());
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        final Biome[] spawnBiomes = this.allbiomes((RegistryNamespaced<ResourceLocation, Biome>)Biome.REGISTRY);
        EntityRegistry.addSpawn(EntityCustom.class, ModConfig.NightmareFreddy.weight, ModConfig.NightmareFreddy.minGroupSize, ModConfig.NightmareFreddy.maxGroupSize, EnumCreatureType.MONSTER, spawnBiomes);
    }
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            final RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
                protected ResourceLocation getEntityTexture(final Entity entity) {
                    return new ResourceLocation("five_nights_at_freddycraft:textures/nightmare_freddy.png");
                }
            };
    ...
    public static class EntityCustom extends EntityMob
    {
        ...
        protected Item getDropItem() {
            return new ItemStack(Items.NETHERBRICK, 1).getItem();
        }
